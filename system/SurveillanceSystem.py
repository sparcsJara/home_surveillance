            ...
            # Frame rate calculation 
             ...
             ##################################################################################################################################################
              ...
              ####################################################################################################################################################################
                    ...
                    if self.resolution_up == False:
                        self.resolution_up = True
                        cnt = 0
                        for target_camera in self.cameras:
                            cnt += 1
                            base_url = target_camera.url[:-10]
                    ...
                    for x, y, w, h in peopleRects:
                        ...
                        for face_bb in camera.faceBoxes: 
                              ...
                              values = {'name': 'photo'}
                              res = requests.post(
                                  'http://ec2-18-191-11-172.us-east-2.compute.amazonaws.com:5000/from_edge/',
